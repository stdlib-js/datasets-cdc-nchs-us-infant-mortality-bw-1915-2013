...
```javascript
dataset = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-cdc-nchs-us-infant-mortality-bw-1915-2013@v0.2.3-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/datasets-cdc-nchs-us-infant-mortality-bw-1915-2013/actions/workflows/test.yml/badge.svg?branch=v0.2.3
[test-url]: https://github.com/stdlib-js/datasets-cdc-nchs-us-infant-mortality-bw-1915-2013/actions/workflows/test.yml?query=branch:v0.2.3
